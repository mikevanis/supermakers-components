...
export default function WelcomeStep2Wind(props) {
  ...
  return (
    <div className={classes.root}>
      <svg xmlns="http://www.w3.org/2000/svg" width={644} height="316.728" viewBox="0 0 644 316.728">
        <g id="Group_1598" data-name="Group 1598" transform="translate(-62 -511.5)">
          <path id="Path_534" data-name="Path 534" d="M150.789,825.364a11.457,11.457,0,0,0-11.457,11.457,14.321,14.321,0,0,0,14.321,14.321,17.9,17.9,0,0,0,17.9-17.9,22.378,22.378,0,0,0-22.378-22.378H67.938" transform="translate(126.158 -23.414)" fill="none" stroke="#182a74" strokeMiterlimit={10} strokeWidth={1} />
          ...
          <path id="Path_308" data-name="Path 308" d="M-2509.263,6045.845a35.174,35.174,0,0,1-35.174,35.173" transform="translate(2966.272 -5328.932)" fill="none" stroke="#000" strokeMiterlimit={10} strokeWidth={1} />
          ...
          <g id="Group_1045" data-name="Group 1045" transform="translate(396.842 674.486)">
            <g id="Group_874" data-name="Group 874" transform="translate(0 0)">
              <g id="Group_676" data-name="Group 676">
                ...
                <rect id="Rectangle_188" data-name="Rectangle 188" width="9.284" height="26.113" fill="none" stroke="#182a74" strokeLinecap="round" strokeMiterlimit={10} strokeWidth={1} />
              </g>
            </g>
          </g>
          <path id="Path_535" data-name="Path 535" d="M127.069,836.642a11.457,11.457,0,0,1-11.457-11.458,14.322,14.322,0,0,1,14.321-14.321,17.9,17.9,0,0,1,17.9,17.9,22.378,22.378,0,0,1-22.378,22.378H-4.745" transform="translate(160.744 -298.863)" fill="none" stroke="#182a74" strokeMiterlimit={10} strokeWidth={1} />
          ...
          <line id="Line_254" data-name="Line 254" x2={94} transform="translate(612 656)" fill="none" stroke="#182a74" strokeWidth={1} />
        </g>
      </svg>
